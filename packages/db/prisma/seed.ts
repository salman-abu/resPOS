...
async function main() {
  ...
  type ItemSeed = {
    ...
    tax_slab: 'GST_5' | 'GST_12';
    station_route: 'HOT_KITCHEN' | 'COLD_KITCHEN' | 'BAR' | 'BAKERY';
    sort_order: number;
  };
  ...
  const items: ItemSeed[] = [
    {
      ...
      category_id: 'cat-1',
      name: 'Paneer Tikka',
      description: 'Smoky cottage cheese in spiced yogurt',
      base_price: 28000,
      item_type: V,
      tax_slab: G5,
      station_route: HK,
    ...
    },
    {
      ...
      category_id: 'cat-1',
      name: 'Chicken 65',
      description: 'Crispy South Indian fried chicken',
      base_price: 34000,
      item_type: NV,
      tax_slab: G5,
      station_route: HK,
    ...
    },
    {
      ...
      description: 'Crispy rolls with seasoned vegetables',
      base_price: 19000,
      item_type: V,
      tax_slab: G5,
      station_route: HK,
    ...
    },
    {
      ...
      category_id: 'cat-2',
      name: 'Butter Chicken',
      description: 'Tender chicken in tomato-cream sauce',
      base_price: 38000,
      item_type: NV,
      tax_slab: G12,
      station_route: HK,
    ...
    },
    {
      ...
      description: 'Fresh paneer in tomato-cashew gravy',
      base_price: 32000,
      item_type: V,
      tax_slab: G12,
      station_route: HK,
    ...
    },
    {
      ...
      category_id: 'cat-3',
      name: 'Garlic Naan',
      description: 'Tandoor flatbread with garlic and butter',
      base_price: 5000,
      item_type: V,
      tax_slab: G5,
      station_route: HK,
    ...
    },
    {
      ...
      description: 'Hyderabadi dum biryani with chicken',
      base_price: 42000,
      item_type: NV,
      tax_slab: G12,
      station_route: HK,
    ...
    },
    {
      ...
      description: 'Sparkling lime water with mint',
      base_price: 7000,
      item_type: V,
      tax_slab: G5,
      station_route: BAR,
