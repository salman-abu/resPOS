...
const STAFF: StaffMember[] = [
  {
    ...
    coach_tips: [
      {
        type: 'win',
        headline: "You're #1 today — keep it up! 🏆",
        detail:
          "You've served ₹952 revenue, the highest of any staff member this shift.",
      },
      {
        type: 'revenue',
        headline: 'Upsell desserts at bill time',
        detail:
          'Tables that order dessert spend 22% more. Suggest Gulab Jamun or Brownie at closing.',
      },
      {
        type: 'tip',
        headline: 'Your peak hour is 1-2 PM',
        detail:
          'You handle 12 orders/hour at your peak. Schedule your break before or after.',
      },
    ],
  },
  {
    ...
    coach_tips: [
      {
        type: 'warning',
        headline: 'Your avg check is ₹140 below team avg',
        detail:
          'Team avg is ₹280/order. Try suggesting a starter or drink for every table.',
      },
      {
        type: 'revenue',
        headline: 'Drink pairing = ₹500 more/shift',
        detail:
          'Only 2 of your 14 tables ordered a beverage. Ask "Can I start you off with a Lassi?"',
      },
      {
        type: 'tip',
        headline: 'Smile & greet in the first 30 seconds',
        detail:
          'Tables greeted quickly tend to order more and tip better. Check-in speed matters.',
      },
    ],
  },
  {
    ...
    coach_tips: [
      {
        type: 'win',
        headline: 'Highest avg check on the floor — ₹294!',
        detail: 'Your upselling is working. Keep recommending premium dishes.',
      },
      {
        type: 'tip',
        headline: 'Coach Rohan on beverage upsells',
        detail:
          "As manager, your guidance can lift the whole team's revenue by 15%.",
      },
    ],
  },
  {
    ...
    coach_tips: [
      {
        type: 'win',
        headline: '41 dishes out — fastest kitchen today! 🔥',
        detail: 'Your avg ticket time is 8.2 min, below the 10-min target.',
      },
      {
        type: 'tip',
        headline: 'Batch similar items together',
        detail:
          'Grouping Biryanis and curries in the same batch reduces cook time by 15%.',
      },
    ],
  },
  {
    ...
    coach_tips: [
      {
        type: 'warning',
        headline: 'Only 15 orders vs 40 target',
        detail:
          "You're at 38% of your daily goal. Focus on faster table turns.",
      },
      {
        type: 'revenue',
        headline: 'Recommend the ₹380 Chicken Biryani',
        detail:
          "It's the highest margin dish today. Push it at every main course decision.",
      },
    ],
  },
  {
    ...
    coach_tips: [
      {
        type: 'win',
        headline: 'Best tip rate on the team — ₹50/cover!',
        detail:
          'Your guests love your service. Keep up the personalised recommendations.',
      },
      {
        type: 'revenue',
        headline: 'Push premium mocktails this afternoon',
        detail:
          'The 2-4 PM slow period is a great time to upsell Virgin Mojito (₹120).',
      },
    ],
  },
];
