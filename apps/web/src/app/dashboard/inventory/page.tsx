    ...
    <div className="p-6 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-content-muted">
              {ITEMS.length} ingredients tracked · {lowStock.length} low stock
            </p>
          </div>
        </div>
        <button
        ...
        <div className="flex items-start gap-3 p-4 rounded-2xl bg-red-50 border border-red-200">
          ...
          <div>
            <p className="font-bold text-red-700 text-sm">
              Stock Alert: {lowStock.length} items need restocking
            </p>
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          {
            label: 'Critical',
            value: ITEMS.filter((i) => i.currentStock <= i.minStock * 0.5)
              .length,
            color: 'text-red-500',
          },
        ].map((s) => (
              ...
              return (
                <tr
                  ...
                  className={cn(
                    ...
                    item.currentStock <= item.minStock && 'bg-red-50/30',
                  )}
                >
                  ...
                  <td className="px-4 py-3.5 text-content-primary">
                    ₹{item.costPerUnit}
                  </td>
                  <td className="px-4 py-3.5">
                    <span
                      className={cn(
                        'flex items-center gap-1.5 text-xs font-bold px-2 py-0.5 rounded-full border w-fit',
                        st.color,
                      )}
                    >
                      <span
