...
> _A comprehensive technical and product manifest mapping out the architecture, 11 next-gen core modules, structural rules, and completed critical bug resolutions for resPOS 2.0._
...
- **Kitchen Order Tickets (KOT):** Instant visual dispatch to specific kitchen stations (_Hot Kitchen_, _Cold Kitchen_, _Bar_, _Bakery_).
...
- **Dual View:** One-click toggling between _Terminal Scan Grid_ (large visual buttons) and _Terminal List View_ (compact list for rapid desktop cashiers).
...
- **Mechanics:**
  ...
  - _Digital Stamps:_ Automatically increments stamp counts when triggering menu items are purchased, awarding free items on completing target goals (e.g. _"Buy 5 Coffees, Get 1 Free"_).
